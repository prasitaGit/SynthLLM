...
Module Info.
  ...
  Definition source_file := "proggen.c".
...
Definition _swapadd : ident := $"swapadd".
Definition _x : ident := $"x".
Definition _y : ident := $"y".
Definition _t'1 : ident := 128%positive.
Definition _t'2 : ident := 129%positive.

Definition f_swapadd := {|
  fn_return := tvoid;
...
(Ssequence
  (Ssequence
    (Sset _t'2 (Ederef (Etempvar _y (tptr tint)) tint))
    (Sassign (Ederef (Etempvar _x (tptr tint)) tint)
      (Ebinop Oadd (Etempvar _t'2 tint) (Econst_int (Int.repr 2) tint) tint)))
  (Ssequence
    (Sset _t'1 (Ederef (Etempvar _x (tptr tint)) tint))
    (Sassign (Ederef (Etempvar _y (tptr tint)) tint)
      (Ebinop Osub (Etempvar _t'1 tint) (Econst_int (Int.repr 1) tint) tint))))
|}.
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_swapadd, Gfun(Internal f_swapadd)) :: nil).

Definition public_idents : list ident :=
(_swapadd :: ___builtin_debug :: ___builtin_fmin :: ___builtin_fmax ::
